...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _modules_burger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/burger.js */ \"./src/js/modules/burger.js\");\n/* harmony import */ var _modules_spoler_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/spoler.js */ \"./src/js/modules/spoler.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/js/swiper.esm.bundle.js\");\n\r\n// Функція для провірки браузера на підтримке плагина для сборки gulp\r\n\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\n// Функція для адаптивного меню. Меню при зменшенні екрану складується в меню бургер\r\n// import * as adaptiveMenu from \"./modules/adaptiveMenu.js\";\r\n\r\n// adaptiveMenu.adaptiveMenu(); меню в стадії розробки\r\n\r\n// Функція бургер меню\r\n\r\n\r\n_modules_burger_js__WEBPACK_IMPORTED_MODULE_1__.burger();\r\n\r\n// Функція для стилізації чекбоксов\r\n// import * as checkBox from \"./modules/check-box.js\";\r\n\r\n// checkBox.checkBox();\r\n\r\n//\tФункція для зміни типу інпута що призначений для введення паполя\r\n// import * as lookpassword from \"./modules/lookPasword.js\";\r\n\r\n// lookpassword.lookpassword();\r\n\r\n// Функція для модального вікна\r\n// import * as popup from \"./modules/popup.js\";\r\n\r\n// popup.popup();\r\n\r\n// Функція для лічильника кількості покупки\r\n// import * as quantity from \"./modules/quantity.js\";\r\n\r\n// quantity.quantity();\r\n\r\n// Функція для стилізації радіо-кнопок\r\n// import * as radio from \"./modules/radio.js\";\r\n\r\n// radio.radio();\r\n\r\n// Функція для плавного зникнення і появлення блоку\r\n// import * as slideToggle from \"./modules/slideToggle.js\";\r\n\r\n// slideToggle.slideToggle();\r\n\r\n// Функція для сполерів\r\n\r\n\r\n_modules_spoler_js__WEBPACK_IMPORTED_MODULE_2__.spoler();\r\n\r\n// Функція для табів\r\n// import * as tabs from \"./modules/tabs.js\";\r\n\r\n// tabs.tabs();\r\n\r\n// Бібліотека для слайдерів SWIPER\r\n\r\n\r\nconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]( \".slider-page__swiper\", {\r\n\t// Пагінація\r\n\tpagination: { \r\n\t\t// Елемент пагінації\r\n\t\tel: '.slider-page__slider-pagination', \r\n\t\t// Тип\r\n\t\ttype: 'fraction',\r\n\t\t// Можна керувати кліками по пагінації\r\n\t\tclickable: true,\r\n\t\trenderFraction: function (currentClass, totalClass) {\r\n\t\t\treturn '<span class=\"' + currentClass + '\"></span>' +\r\n\t\t\t\t\t  ' из ' +\r\n\t\t\t\t\t  '<span class=\"' + totalClass + '\"></span>';\r\n\t  }\r\n\t},\r\n\tnavigation: {\r\n\t\tnextEl: '.slider-page__navigation-next',\r\n\t\tprevEl: '.slider-page__navigation-prev',\r\n\t },\r\n\t// Відступи між слайдами\r\n\t// spaceBetween: 60,\r\n\t// Кількість слайдів\r\n\tslidesPerView: 1,\r\n\t// Нескінченне гортання\r\n\t// loop: true,\r\n\t// Авто гортання\r\n\t// autoplay: {\r\n\t// \t// Кількість мілісекунд\r\n\t// \tdelay: 2000\r\n\t// },\r\n\t// Брейкпоінти\r\n\t// breakpoints: {\r\n\t// },\r\n\tloop: true,\r\n\t\t\tloopedSlides: 4\r\n} )\r\nconst swiperThumbs = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('.slider-page__slider-thumbs', {\r\n\tspaceBetween: 30,\r\n\t// slidesPerView: 4,\r\n\ttouchRatio: 0.2,\r\n\tslideToClickedSlide: true,\r\n\tloop: true,\r\n\tloopedSlides: 4,\r\n\tbreakpoints: {\r\n\t\t320: {\r\n\t\t\tslidesPerView: 3\r\n\t\t},\r\n\t\t480: {\r\n\t\t\tslidesPerView: 4,\r\n\t\t\tspaceBetween: 10\r\n\t\t},\r\n\t\t768: {\r\n\t\t\tslidesPerView: 4,\r\n\t\t\tspaceBetween: 30\r\n\t\t}\r\n\t}\r\n });\r\n\r\nconst swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]( \".slider-page__gallery-swiper\", {\r\n\t// Відступи між слайдами\r\n\t// spaceBetween: 60,\r\n\t// Кількість слайдів\r\n\tslidesPerView: 1,\r\n\tautowidth: true,\r\n\t// Нескінченне гортання\r\n\t// loop: true,\r\n\t// Авто гортання\r\n\t// autoplay: {\r\n\t// \t// Кількість мілісекунд\r\n\t// \tdelay: 2000\r\n\t// },\r\n\t// Брейкпоінти\r\n\t// breakpoints: {\r\n\t// },\r\n\tloop: true,\r\n\t\t\tloopedSlides: 4\r\n} )\r\n\r\nconst swiperThumbs2 = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('.slider-page__gallery-thumbs', {\r\n\tcenteredSlides: false,\r\n\tslidesPerView: 5,\r\n\ttouchRatio: 0.2,\r\n\tslideToClickedSlide: true,\r\n\tspaceBetween: 0,\r\n\tloop: true,\r\n\tloopedSlides: 4,\r\n});\r\n\r\nswiperThumbs.controller.control = swiper;\r\nswiper.controller.control = swiperThumbs;\r\n\r\nswiperThumbs2.controller.control = swiper2;\r\nswiper2.controller.control = swiperThumbs2;\r\n\r\nconst swiper3 = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]( \".instruction__swiper\", {\r\n\t// Пагінація\r\n\tpagination: { \r\n\t\t// Елемент пагінації\r\n\t\tel: '.instruction__slider-pagination', \r\n\t\t// Тип\r\n\t\ttype: 'fraction',\r\n\t\t// Можна керувати кліками по пагінації\r\n\t\tclickable: true,\r\n\t\trenderFraction: function (currentClass, totalClass) {\r\n\t\t\treturn '<span class=\"' + currentClass + '\"></span>' +\r\n\t\t\t\t\t  ' из ' +\r\n\t\t\t\t\t  '<span class=\"' + totalClass + '\"></span>';\r\n\t  }\r\n\t},\r\n\tnavigation: {\r\n\t\tnextEl: '.instruction__navigation-next',\r\n\t\tprevEl: '.instruction__navigation-prev',\r\n\t },\r\n\t// Відступи між слайдами\r\n\t// Кількість слайдів\r\n\tslidesPerView: 5.1,\r\n\t// Нескінченне гортання\r\n\t// loop: true,\r\n\t// Авто гортання\r\n\t// autoplay: {\r\n\t// \t// Кількість мілісекунд\r\n\t// \tdelay: 2000\r\n\t// },\r\n\tloop: true,\r\n\tcenteredSlides: true,\r\n\t// Брейкпоінти\r\n\tbreakpoints: {\r\n\t\t320: {\r\n\t\t\tslidesPerView: 1.1,\r\n\t\t},\r\n\t\t478: {\r\n\t\t\tslidesPerView: 1.5,\r\n\t\t},\r\n\t\t768: {\r\n\t\t\tslidesPerView: 3.1,\r\n\t\t},\r\n\t\t998: {\r\n\t\t\tslidesPerView: 5.1\r\n\t\t}\r\n\t},\r\n} )\r\n\r\n// Бібліотека для фільтрів\r\n// import mixitup from 'mixitup';\r\n\r\n// const mixer = mixitup(\".block-gallery__blocks\", {\r\n// \tanimation: {\r\n// \t\tenable: true,\r\n// \t\tduration: 250,\r\n// \t\tnudge: false,\r\n// \t\treverseOut: false,\r\n// \t\teffects: \"fade translateY(20%)\"\r\n//   }\r\n// });\r\n\r\nlet sliderWidthWindow = window.innerWidth;\r\n\r\nif( sliderWidthWindow <= 991.98 ) {\r\n\tconst sliderGallery = document.querySelector( '.slider-page__gallery-slider' );\r\n\tconst nextSliderGallery = document.querySelector( '.slider-page__center-slider' );\r\n\r\n\tnextSliderGallery.prepend( sliderGallery );\r\n}\r\n\r\naddEventListener( \"resize\", e => {\r\n\tsliderWidthWindow = window.innerWidth;\r\n\r\n\tif( sliderWidthWindow <= 991.98 ) {\r\n\t\tconst sliderGallery = document.querySelector( '.slider-page__gallery-slider' );\r\n\t\tconst nextSliderGallery = document.querySelector( '.slider-page__center-slider' );\r\n\r\n\t\tnextSliderGallery.prepend( sliderGallery );\r\n\t}\r\n\r\n\tif( sliderWidthWindow > 991.98 ) {\r\n\t\tconst sliderGallery = document.querySelector( '.slider-page__gallery-slider' );\r\n\t\tconst nextSliderGallery = document.querySelector( '.slider-page' );\r\n\r\n\t\tnextSliderGallery.append( sliderGallery );\r\n\t}\r\n\r\n} )\r\n\r\nfunction scrillTo( el ) {\r\n\twindow.scroll({\r\n\t\tleft: 0,\r\n\t\ttop: el.offsetTop,\r\n\t\tbehavior: 'smooth'\r\n\t})\r\n}\r\n\r\nconst endScroll = document.querySelector( '.to-top-end' );\r\nconst startScroll = document.querySelector( '.to-top' );\r\n\r\nstartScroll.addEventListener( 'click', e => {\r\n\tscrillTo( endScroll );\r\n\te.preventDefault();\r\n} )\n\n//# sourceURL=webpack://new-gulp/./src/js/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"burger\": () => (/* binding */ burger)\n/* harmony export */ });\nfunction burger() {\r\n\tconst burgerLink     = document.querySelectorAll( '.burger__link-active' );\r\n\tconst burger         = document.querySelectorAll( '.burger' );\r\n\tconst burgerBodyExit = document.querySelectorAll( '.burger__link-back' );\r\n\tconst body           = document.body;\r\n\r\n\tif( burgerLink.length > 0 ) {\r\n\t\tfor( let i = 0; i < burgerLink.length; i++ ) {\r\n\t\t\tburgerLink[i].addEventListener( 'click', addOpen )\r\n\t\t}\r\n\t}\r\n\r\n\tfunction addOpen(e) {\r\n\t\t\r\n\t\t\te.currentTarget.classList.toggle( \"active__link\" );\r\n\t\t\r\n\t\tburger[0].classList.add( \"open__burger\" )\r\n\t\tbody.style.overflowY = \"hidden\";\r\n\t\te.preventDefault();\r\n\t}\r\n\r\n\tif( burgerBodyExit.length > 0 ) {\r\n\t\tfor( let i = 0; i < burgerBodyExit.length; i++ ) {\r\n\t\t\tburgerBodyExit[i].addEventListener( 'click', addOpenE )\r\n\t\t}\r\n\t}\r\n\r\n\tfunction addOpenE(e) {\r\n\t\t\r\n\t\t\te.currentTarget.classList.remove( \"active__link\" );\r\n\t\t\r\n\t\tburger[0].classList.remove( \"open__burger\" )\r\n\t\tbody.style.overflowY = \"\";\r\n\t\te.preventDefault();\r\n\t}\r\n}\n\n//# sourceURL=webpack://new-gulp/./src/js/modules/burger.js?");
